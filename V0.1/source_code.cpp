...
int main()
{
    ...
    for (unsigned t_pass = 0 ; t_pass < 2000 ; t_pass++) {
        ...
        my_neural_net.feedForward(input_vals);

        my_neural_net.getResults(result_vals);
        std::cout << "[ ";
        for (unsigned o = 0 ; o < result_vals.size() ; o++) {
        ...
        my_neural_net.backProp(target_vals);
    }
}
